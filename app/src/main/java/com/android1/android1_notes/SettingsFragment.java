...
public class SettingsFragment extends Fragment {
    ...
    private void initView(View view) { // init здесь отрисовывает всё
    ...
    private void writeSettings(){
        ...
        // MODE_PRIVATE - доступ только из приложения
